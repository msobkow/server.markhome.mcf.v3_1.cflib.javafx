...
public class CFDbKeyHash128Editor
extends CFTextField
{
	protected final static int MAX_LEN = CFLibDbKeyHash128.HASH_LENGTH_STRING;
	...
	public void setDbKeyHash128Value( CFLibDbKeyHash128 value ) {
		if( value != null ) {
	...
	public CFLibDbKeyHash128 getDbKeyHash128Value() {
		final String S_ProcName = "getDbKeyHash128Value";
		String text = getText();
		if( text == null || text.isEmpty() ) {
			...
			try {
				CFLibDbKeyHash128 retval = CFLibDbKeyHash128.fromHex(text);
				return( retval );
			}
			catch( Throwable th ) {

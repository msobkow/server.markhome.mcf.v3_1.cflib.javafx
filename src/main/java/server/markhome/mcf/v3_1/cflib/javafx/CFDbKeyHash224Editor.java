...
public class CFDbKeyHash224Editor
extends CFTextField
{
	protected final static int MAX_LEN = CFLibDbKeyHash224.HASH_LENGTH_STRING;
	...
	public void setDbKeyHash224Value( CFLibDbKeyHash224 value ) {
		if( value != null ) {
	...
	public CFLibDbKeyHash224 getDbKeyHash224Value() {
		final String S_ProcName = "getDbKeyHash224Value";
		String text = getText();
		if( text == null || text.isEmpty() ) {
			...
			try {
				CFLibDbKeyHash224 retval = CFLibDbKeyHash224.fromHex(text);
				return( retval );
			}
			catch( Throwable th ) {

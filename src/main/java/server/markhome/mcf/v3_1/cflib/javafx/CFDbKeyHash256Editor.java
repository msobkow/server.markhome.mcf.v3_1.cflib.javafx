...
public class CFDbKeyHash256Editor
extends CFTextField
{
	protected final static int MAX_LEN = CFLibDbKeyHash256.HASH_LENGTH_STRING;
	...
	public void setDbKeyHash256Value( CFLibDbKeyHash256 value ) {
		if( value != null ) {
	...
	public CFLibDbKeyHash256 getDbKeyHash256Value() {
		final String S_ProcName = "getDbKeyHash256Value";
		String text = getText();
		if( text == null || text.isEmpty() ) {
			...
			try {
				CFLibDbKeyHash256 retval = CFLibDbKeyHash256.fromHex(text);
				return( retval );
			}
			catch( Throwable th ) {

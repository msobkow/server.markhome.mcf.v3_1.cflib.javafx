...
public class CFUuid6Editor
extends CFTextField
{
	protected final static int MAX_LEN = CFLibUuid6.STRING_LENGTH;
	...
	public void setUuid6Value( CFLibUuid6 value ) {
		if( value != null ) {
	...
	public CFLibUuid6 getUuid6Value() {
		final String S_ProcName = "getUuid6Value";
		String text = getText();
		if( text == null || text.isEmpty() ) {
			...
			try {
				CFLibUuid6 retval = CFLibUuid6.fromString(text);
				return( retval );
			}
			catch( Throwable th ) {

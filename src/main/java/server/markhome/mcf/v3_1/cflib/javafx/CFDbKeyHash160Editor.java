...
public class CFDbKeyHash160Editor
extends CFTextField
{
	protected final static int MAX_LEN = CFLibDbKeyHash160.HASH_LENGTH_STRING;
	...
	public void setDbKeyHash160Value( CFLibDbKeyHash160 value ) {
		if( value != null ) {
	...
	public CFLibDbKeyHash160 getDbKeyHash160Value() {
		final String S_ProcName = "getDbKeyHash160Value";
		String text = getText();
		if( text == null || text.isEmpty() ) {
			...
			try {
				CFLibDbKeyHash160 retval = CFLibDbKeyHash160.fromHex(text);
				return( retval );
			}
			catch( Throwable th ) {

...
public class CFDbKeyHash512Editor
extends CFTextField
{
	protected final static int MAX_LEN = CFLibDbKeyHash512.HASH_LENGTH_STRING;
	...
	public void setDbKeyHash512Value( CFLibDbKeyHash512 value ) {
		if( value != null ) {
	...
	public CFLibDbKeyHash512 getDbKeyHash512Value() {
		final String S_ProcName = "getDbKeyHash512Value";
		String text = getText();
		if( text == null || text.isEmpty() ) {
			...
			try {
				CFLibDbKeyHash512 retval = CFLibDbKeyHash512.fromHex(text);
				return( retval );
			}
			catch( Throwable th ) {

...
extends CFTextField
{
	...
	protected LocalTime curValue = null;
	...
	public boolean isEditValid() {
		...
		curValue = null;
		curValue = CFLibXmlUtil.parseTZTime( Inz.x(fieldNameInzTag), Inz.s(fieldNameInzTag), text );
		return( true );
	}

	public void setTZTimeValue( LocalTime value ) {
		curValue = value;
		if( curValue != null ) {
	...
	public LocalTime getTZTimeValue() {

...
extends CFTextField
{
	public final static LocalDateTime MIN_VALUE = CFLibXmlUtil.parseTimestamp("0000-01-01 00:00:00");
	...
	public boolean isEditValid() {
		...
		curValue = null;
		curValue = CFLibXmlUtil.parseTimestamp( Inz.x(fieldNameInzTag), Inz.s(fieldNameInzTag), text );
		return( true );
	}
